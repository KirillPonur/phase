...
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/9.jpg} 
%             \vspace{0pt}
%             \label{fig:10}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/8.jpg} 
%             \vspace{0pt}
%             \label{fig:11}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
% %             \includegraphics[height=100pt]{photos/7.jpg} 
%             \vspace{0pt}
%             \label{fig:12}
%             \captionof{subfigure}{} 
%         \end{minipage}
...
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/6.jpg} 
%             \vspace{0pt}
%             \label{fig:10}
%             \captionof{subfigure}{} 
%         \end{minipage}
%     \begin{minipage}{0.32\linewidth}
%         \centering
%         \includegraphics[height=100pt]{photos/5.jpg} 
%         \vspace{0pt}
%         \label{fig:11}
%         \captionof{subfigure}{} 
%     \end{minipage}
%     \begin{minipage}{0.32\linewidth}
%         \centering
%         \includegraphics[height=100pt]{photos/4.jpg} 
%         \vspace{0pt}
%         \label{fig:12}
%         \captionof{subfigure}{} 
%     \end{minipage}
...
%         \vspace{-10pt}
%         \centering
%         \includegraphics[height=120pt]{photos/3.jpg} 
%         \vspace{0pt}
%         \label{fig:10}
%         \captionof{figure}{} 
%         \vspace{-20pt}
...
%         \vspace{-10pt}
%         \centering
%         \includegraphics[height=120pt]{photos/2.jpg} 
%         \vspace{0pt}
%         \label{fig:10}
%         \captionof{figure}{} 
%         \vspace{-20pt}
...
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/1.jpg} 
%             \vspace{0pt}
%             \label{fig:10}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/18.jpg} 
%             \vspace{0pt}
%             \label{fig:11}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/17.jpg} 
%             \vspace{0pt}
%             \label{fig:12}
%             \captionof{subfigure}{} 
%         \end{minipage}
...
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/16.jpg} 
%             \vspace{0pt}
%             \label{fig:10}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/15.jpg} 
%             \vspace{0pt}
%             \label{fig:11}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/14.jpg} 
%             \vspace{0pt}
%             \label{fig:12}
%             \captionof{subfigure}{} 
%         \end{minipage}
...
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/13.jpg} 
%             \vspace{0pt}
%             \label{fig:10}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/12.jpg} 
%             \vspace{0pt}
%             \label{fig:11}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/11.jpg} 
%             \vspace{0pt}
%             \label{fig:12}
%             \captionof{subfigure}{} 
%         \end{minipage}
...
\subsection{Сильно-жесткий режим генератора}
...
\begin{center}
    \begin{figure}[H]
        \vspace{-10pt}
            ...
            \vspace{-10pt}
            \label{fig:10}
            \captionof{figure}{Бифуркационная диаграмма для сильно-жесткого режима генератора} 
            \vspace{-40pt}
    \end{figure}
\end{center} 
...
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/10.jpg} 
%             \vspace{0pt}
%             \label{fig:10}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/26.jpg} 
%             \vspace{0pt}
%             \label{fig:11}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/25.jpg} 
%             \vspace{0pt}
%             \label{fig:12}
%             \captionof{subfigure}{} 
%         \end{minipage}
...
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/24.jpg} 
%             \vspace{0pt}
%             \label{fig:10}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/23.jpg} 
%             \vspace{0pt}
%             \label{fig:11}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/21.jpg} 
%             \vspace{0pt}
%             \label{fig:12}
%             \captionof{subfigure}{} 
%         \end{minipage}
...
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/22.jpg} 
%             \vspace{0pt}
%             \label{fig:10}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/20.jpg} 
%             \vspace{0pt}
%             \label{fig:11}
%             \captionof{subfigure}{} 
%         \end{minipage}
%         \begin{minipage}{0.32\linewidth}
%             \centering
%             \includegraphics[height=100pt]{photos/19.jpg} 
%             \vspace{0pt}
%             \label{fig:12}
%             \captionof{subfigure}{} 
%         \end{minipage}
